...
\begin{enumerate} \itemsep -0.3em
  ...
  \item[] A context is the thing, place, time of day, or energy level required before the task can be done.\marginnote{Pro-tip: Make
  ...
  an agenda to email them. It let's them know you value their time.}
\end{enumerate}
...
% you can maximize your overall efficiency through the day.
...
searching.\sidenote{Think of your notes as digital versions of index
